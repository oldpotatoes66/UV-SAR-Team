...
static const AddrMapping_t ADDR_MAPPINGS[] = {
    ...
    // SAR-TEAM identity/configuration. Dedicated sector: never share an
    // erase/write sector with the 512-byte calibration block above.
    _MK_MAPPING(0x012000, 0x00D000, 0x00D008),
