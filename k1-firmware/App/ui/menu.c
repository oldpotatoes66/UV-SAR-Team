    ...
    switch (m)
    {
        ...
        case MENU_VOL: {
            ...
            if (page == p++) {
                ...
                UI_PrintStringSmallNormal(val, menu_item_x1 - 1, menu_item_x2, 1);
                UI_PrintString(AUTHOR_STRING_1, menu_item_x1, menu_item_x2, 2, 8);
                UI_PrintString(VERSION_STRING_2, menu_item_x1, menu_item_x2, 4, 8);
