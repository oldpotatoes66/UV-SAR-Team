...
void ACTION_Power(void)
{
    ...
    // F+6 is the K1 power shortcut.  Force the main screen and status area to
    // be redrawn so the new L1..L5/M/H value is visible immediately.
    gRequestDisplayScreen = DISPLAY_MAIN;
    gUpdateDisplay = true;
    gUpdateStatus = true;
    gPowerDisplayCountdown_500ms = 3; // about 1.5 seconds
